...
void PrintStudents(const Student *students, const int N)
{
    ...
    {
        cout << "|" << setw(3) << i + 1
             << " | " << setw(19) << left << students[i].prizv
             << " | " << setw(4) << right << students[i].kurs
             << " | " << setw(21) << left << specialnistStr[students[i].specialnist];

        // Виведення оцінок залежно від спеціальності
        if (students[i].specialnist == KN || students[i].specialnist == INF)
        {
            cout << " | " << setw(8) << students[i].grades.kn_inf.ocinka_fizyka
                 << " | " << setw(12) << students[i].grades.kn_inf.ocinka_matematyka
                 << " | " << setw(15) << students[i].grades.kn_inf.ocinka_programming
                 << " | " << setw(9) << "-"
                 << " | " << setw(12) << "-" << " |" << endl;
        }
        else if (students[i].specialnist == ME)
        {
            cout << " | " << setw(8) << students[i].grades.me.ocinka_fizyka
                 << " | " << setw(12) << students[i].grades.me.ocinka_matematyka
                 << " | " << setw(15) << "-"
                 << " | " << setw(9) << students[i].grades.me.ocinka_chiselni_metody
                 << " | " << setw(12) << "-" << " |" << endl;
        }
        else if (students[i].specialnist == FI || students[i].specialnist == TN)
        {
            cout << " | " << setw(8) << students[i].grades.fi_tn.ocinka_fizyka
                 << " | " << setw(12) << students[i].grades.fi_tn.ocinka_matematyka
                 << " | " << setw(15) << "-"
                 << " | " << setw(9) << "-"
                 << " | " << setw(12) << students[i].grades.fi_tn.ocinka_pedagogika << " |" << endl;
        }
    }
    cout << "=====================================================================================================================" << endl;
}
